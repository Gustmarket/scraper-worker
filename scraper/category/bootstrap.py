...
entities_to_bootstrap = [
    ...
    create_entity_to_bootstrap("https://www.kiteworldshop.com/en/24-twintip", "KITEBOARDS", None, ["TWINTIP"]),
    create_entity_to_bootstrap("https://www.glissattitude.com/en/shop/category/kitesurf-aile-kitesurf-1111", "KITES", None),
    create_entity_to_bootstrap("https://www.glissattitude.com/en/shop/category/kitesurf-planche-kitesurf-planche-kitesurf-twintip-1108", "KITEBOARDS", None, ["TWINTIP"]),
    create_entity_to_bootstrap("https://www.magasin-glissevolution.com/14-ailes-de-kite", "KITES", None),
    create_entity_to_bootstrap("https://www.magasin-glissevolution.com/196-twin-tips", "KITEBOARDS", None, ["TWINTIP"]),
    ...
    create_entity_to_bootstrap("https://www.zephcontrol.com/98-twin-tip", "KITEBOARDS", None, ["TWINTIP"]),
